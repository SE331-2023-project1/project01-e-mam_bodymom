        ...
        <div class="mt-3 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="#" @submit.prevent="onSubmit">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <InputText v-model="password" type="password" class="text-emerald-600 text-sm font-semibold" placeholder="Enter Password (at least 6 characters long)" ></InputText>
                        <div v-if="errors['password']" class="text-red-500 text-sm my-2" style="font-weight: 600; font-size: small;">❌ {{ errors['password'] }}</div>
                ...
                <div>
                    ...
                    hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Log in</button>
                </div>
            </form>
