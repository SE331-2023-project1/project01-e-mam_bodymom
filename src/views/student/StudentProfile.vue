...
const onSubmit = handleSubmit(async (values) => {
  try {
    await authStore.studentUpdateProfile(student.value.data.id, values.firstName, values.lastName);
...
<template>
  <main class="flex flex-col items-center justify-center">
    <div
      class="font-fig flex items-center justify-center p-3 w-3/4 sm:w-2/4 h-4/5 text-2xl font-bold text-gray-900"
    >
      Profile
    </div>
    <div
